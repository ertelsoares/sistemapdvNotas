 ...
 */
$config['site_title']                 = "TudoNet";       // Site Title, example.com This is not more functional
$config['admin_email']                = "contact@tudo-net.com"; // Admin Email, admin@example.com This is not more functional

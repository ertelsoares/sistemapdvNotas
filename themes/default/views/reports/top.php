                    ...
                    <div class="col-sm-12 noprint" style="text-align:right;margin-bottom:10px;">
                        ...
                        <div class="col-md-6">   
                            <div class="panel panel-default">
                                <div class="panel-heading"><?= $this->lang->line("this_month").' ('.date('m/Y').')'; ?></div>
                        ...
                        <div class="col-md-6">   
                            <div class="panel panel-default">
                                <div class="panel-heading"><?= $this->lang->line("last_month").' ('.date('m/Y', strtotime('last month')).')'; ?></div>
                                <div class="panel-body">
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-6">   
                            <div class="panel panel-default" style="margin-bottom:0;">
                                <div class="panel-heading"><?= $this->lang->line("last_3_months").' ('.$this->lang->line("from").' '.date('m/Y', strtotime('-3 month')).')'; ?></div>
                                <div class="panel-body">
                        ...
                        <div class="col-md-6">   
                            <div class="panel panel-default" style="margin-bottom:0;">
                                <div class="panel-heading"><?= $this->lang->line("last_12_months").' ('.$this->lang->line("from").' '.date('m/Y', strtotime('-12 month')).')'; ?></div>
                                <div class="panel-body">

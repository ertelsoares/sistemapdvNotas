                    ...
                    <div class="col-md-6">
                        ...
                        <?php if ($Admin) { ?>
                            <div class="form-group">
                                <?= lang("date", "date"); ?>
                                <?= form_input('date', (isset($_POST['date']) ? $_POST['date'] : date("d/m/Y", strtotime($expense->date))), 'class="form-control datetimepicker" id="date" required="required"'); ?>
                            </div>
                            <?php } ?>
                            ...
                            <div class="form-group">
                                <?= lang("amount", "amount"); ?>
                                <?= form_input('amount', (isset($_POST['amount']) ? $_POST['amount'] : $this->tec->formatMoney($expense->amount)), 'class="form-control tip dinheiroinput" id="amount"'); ?>
                            </div>

            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <?= lang("date", "date"); ?>
                        <?= form_input('date', (isset($_POST['date']) ? $_POST['date'] : date('d/m/Y H:i')), 'class="form-control datetimepicker" id="date" required="required"'); ?>
                    </div>
                </div>
                <?php } ?>
                <div class="col-sm-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    required="required">
                                    <?php
                                    $allowcash = ($countcash>=1)? false : true; 
                                    foreach($meiopagamento as $mp){ 
                                        if($mp->cod=="cash"){ 
                                            if($allowcash===true){ ?> 
                                        <option value="<?= $mp->cod; ?>"><?= $mp->nome; ?></option>
                                        <?php }
                                        } else{ ?>
                                            <option value="<?= $mp->cod; ?>"><?= $mp->nome; ?></option>
                                        <?php } } ?>
